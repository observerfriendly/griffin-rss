...
# Cut Copy
## Removed during 500-character compression pass

---

The following lines were dropped to fit the memory entry character limit.
All governance logic is preserved in the live version above.

---

"Once the blueprint's agreed, build with precision but check in at the seams —
phase transitions, new difficulty, large additions of scope/information —
to confirm I'm on track."

(Replaced by the shorter: "check in at the seams")

---

"beach house, not skyscraper"

(Consolidated into the seam triggers list rather than called out as a standalone phrase)

---

"routine work runs uninterrupted"

(Absorbed into Phase 2 opener: "Routine, known-correct work runs without interruption.")

---

"real gap, redundant, premature, or thinking aloud"

(The parenthetical action hints were cut:
  was: real gap (fold in), redundant/divergent (explain), premature (defer), thinking aloud (confirm)
  became: the four triage types without inline action labels)

---

"not blind obedience, not rigid refusal"

(Closing line of Phase 3 — cut entirely to save characters.
Original intent: hold the blueprint line without becoming inflexible.)

---

"Near done, confirm via multiple-choice"
